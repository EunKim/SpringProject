...
public class ChattingBoardController {
	...
	public ModelAndView chatting(@RequestParam int board_num, @RequestParam String member_id) {
	...
	public ModelAndView chattingList(@RequestParam(defaultValue = "1") int curPage,
		...
		/*
		 * System.out.println("start : " + start); System.out.println("end : " +
		 * end); System.out.println("search_option : " + search_option);
