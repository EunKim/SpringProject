...
<body>
   ...
   <div align="center" style="margin-top: 30px;">
      <form class="form-horizontal" style="width: 40%; text-align: center;" name="formBoardwrite" method="post">
         ...
         <fieldset>
            ...
            <div class="form-group">
               ...
               <label class="col-lg-3 control-label" for="inputMeetingTime" style="font-size: 13px; margin: auto;">만날시간</label>
               <div class="col-lg-3 input-group clockpicker" data-placement="right" data-autoclose="true">
                  <input type="text" class="form-control " id="bomeettime" name="bomeettime" readonly >
